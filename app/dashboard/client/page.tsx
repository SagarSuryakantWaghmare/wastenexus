...
import { Leaf, FilePlus2, Users2, CalendarDays } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-white flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center w-full px-2 sm:px-4 py-10">
        <section className="w-full max-w-6xl mx-auto bg-white rounded-3xl shadow-2xl border border-green-100 p-6 sm:p-12 flex flex-col items-center">
