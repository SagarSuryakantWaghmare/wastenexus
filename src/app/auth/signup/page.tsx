...
export default function SignupPage() {
  const [formData, setFormData] = useState({
    ...
    email: "",
    password: "",
    role: "citizen" as "citizen" | "worker"
  })
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-200 text-gray-700 px-6 py-3 rounded-xl hover:bg-gray-50 hover:border-gray-300 transition-all duration-200 mb-6"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              >
                ...
                <option value="worker">Waste Management Worker</option>
              </select>
            </div>
