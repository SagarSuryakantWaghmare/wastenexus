    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          {/* Problem Section */}
          <Card className="bg-white border border-gray-200 p-8 sm:p-10 shadow-sm hover:shadow-md transition-shadow duration-300">
            ...
            <div className="bg-red-50 border-l-4 border-red-600 p-6 mb-8 rounded">
              <div className="flex items-center gap-3 mb-2">
                ...
                <p className="text-sm font-semibold text-red-600 uppercase tracking-wide">Critical Impact</p>
              </div>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <p className="text-gray-700">Only 5-10% of plastic waste is recycled globally</p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-1.5 h-1.5 bg-red-600 rounded-full mt-2 flex-shrink-0" />
                <p className="text-gray-700">Landfills emit 10% of global greenhouse gases</p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-1.5 h-1.5 bg-red-600 rounded-full mt-2 flex-shrink-0" />
                <p className="text-gray-700">Communities lack access to waste management solutions</p>
              </div>
            </div>
          </Card>
          ...
          <Card className="bg-white border border-gray-200 p-8 sm:p-10 shadow-sm hover:shadow-md transition-shadow duration-300">
            ...
            <div className="bg-green-50 border-l-4 border-green-600 p-6 mb-8 rounded">
              <div className="flex items-center gap-3 mb-2">
                ...
                <p className="text-sm font-semibold text-green-600 uppercase tracking-wide">Our Approach</p>
              </div>
        ...
        <div className="mt-16 text-center">
          <Separator className="mb-8 max-w-xs mx-auto" />
